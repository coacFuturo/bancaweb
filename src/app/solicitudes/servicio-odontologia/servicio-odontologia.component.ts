...
@Component({
  selector: 'app-servicio-odontologia',
  templateUrl: './servicio-odontologia.component.html',
  styleUrls: ['./servicio-odontologia.component.css']
})
export class ServicioOdontologiaComponent implements OnInit {
